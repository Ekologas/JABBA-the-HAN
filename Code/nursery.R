...
results_CCM_ex2 <- do.call(rbind,list(
  ...
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$sst_nursery),c("Recruitment","sst_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#3
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$sst_nursery),c("SSB","sst_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#4
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$PDO_nursery),c("Recruitment","PDO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#5
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$PDO_nursery),c("SSB","PDO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#6
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#7
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$NPGO_nursery),c("SSB","NPGO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#8
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$NPA_nursery),c("Recruitment","NPA_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#9
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$NPA_nursery),c("SSB","NPA_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#10
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$WP_nursery),c("Recruitment","WP_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#11
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$WP_nursery),c("SSB","WP_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#12
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$NAO_nursery),c("Recruitment","NAO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#13
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$NAO_nursery),c("SSB","NAO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#14
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$SOI_nursery),c("Recruitment","SOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#15
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$SOI_nursery),c("SSB","SOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#16
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#17
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$Nino34_nursery),c("SSB","Nino34_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
  ...
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$NOI_nursery),c("Recruitment","NOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#21
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$NOI_nursery),c("SSB","NOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#22
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$NPI_nursery),c("Recruitment","NPI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#23
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$NPI_nursery),c("SSB","NPI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#24
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$AOI_nursery),c("Recruitment","AOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#25
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$AOI_nursery),c("SSB","AOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#26
  do_ccm_runs3(block.temp[!is.na(block.temp$Recruitment&block.temp$AMO_nursery),c("Recruitment","AMO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#27
  do_ccm_runs3(block.temp[!is.na(block.temp$SSB&block.temp$AMO_nursery),c("SSB","AMO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
  ...
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$sst_nursery),c("Recruitment","sst_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#3
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$sst_nursery),c("SSB","sst_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#4
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$PDO_nursery),c("Recruitment","PDO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#5
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$PDO_nursery),c("SSB","PDO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#6
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#7
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPGO_nursery),c("SSB","NPGO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#8
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPA_nursery),c("Recruitment","NPA_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#9
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPA_nursery),c("SSB","NPA_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#10
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$WP_nursery),c("Recruitment","WP_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#11
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$WP_nursery),c("SSB","WP_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#12
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NAO_nursery),c("Recruitment","NAO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#13
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$NAO_nursery),c("SSB","NAO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#14
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$SOI_nursery),c("Recruitment","SOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#15
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$SOI_nursery),c("SSB","SOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#16
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#17
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$Nino34_nursery),c("SSB","Nino34_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
  ...
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NOI_nursery),c("Recruitment","NOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#19
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$NOI_nursery),c("SSB","NOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#20
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPI_nursery),c("Recruitment","NPI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#21
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPI_nursery),c("SSB","NPI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#22
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AOI_nursery),c("Recruitment","AOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#23
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$AOI_nursery),c("SSB","AOI_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#24
  do_ccm_runs3(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AMO_nursery),c("Recruitment","AMO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#25
  do_ccm_runs3(block.temp1[!is.na(block.temp1$SSB&block.temp1$AMO_nursery),c("SSB","AMO_nursery")], 
               ccm_runs_ex2, silent = TRUE) %>%
...
save(results_CCM_ex2,file='./nurseryresults_CCM_ex2.Rdata')
...
results_null_CCM_ex2 <- do.call(rbind,list(
  ...
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$Fishing_pressure),c("SSB","Fishing_pressure")], 
                   ...
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#2
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$sst_nursery),c("Recruitment","sst_nursery")], 
                   ccm_runs_ex2[3,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#3
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$sst_nursery),c("SSB","sst_nursery")], 
                   ccm_runs_ex2[4,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#4
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$PDO_nursery),c("Recruitment","PDO_nursery")], 
                   ccm_runs_ex2[5,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#5
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$PDO_nursery),c("SSB","PDO_nursery")], 
                   ccm_runs_ex2[6,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#6
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
                   ccm_runs_ex2[7,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#7
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$NPGO_nursery),c("SSB","NPGO_nursery")], 
                   ccm_runs_ex2[8,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#8
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$NPA_nursery),c("Recruitment","NPA_nursery")], 
                   ccm_runs_ex2[9,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#9
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$NPA_nursery),c("SSB","NPA_nursery")], 
                   ccm_runs_ex2[10,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#10
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$WP_nursery),c("Recruitment","WP_nursery")], 
                   ccm_runs_ex2[11,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#11
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$WP_nursery),c("SSB","WP_nursery")], 
                   ccm_runs_ex2[12,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#12
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$NAO_nursery),c("Recruitment","NAO_nursery")], 
                   ccm_runs_ex2[13,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#13
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$NAO_nursery),c("SSB","NAO_nursery")], 
                   ccm_runs_ex2[14,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#14
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$SOI_nursery),c("Recruitment","SOI_nursery")], 
                   ccm_runs_ex2[15,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#15
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$SOI_nursery),c("SSB","SOI_nursery")], 
                   ccm_runs_ex2[16,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#16
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
                   ccm_runs_ex2[17,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#17
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$Nino34_nursery),c("SSB","Nino34_nursery")], 
                   ccm_runs_ex2[18,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#18
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$NOI_nursery),c("Recruitment","NOI_nursery")], 
                   ccm_runs_ex2[19,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#19
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$NOI_nursery),c("SSB","NOI_nursery")], 
                   ccm_runs_ex2[20,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#20
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$NPI_nursery),c("Recruitment","NPI_nursery")], 
                   ccm_runs_ex2[21,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#21
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$NPI_nursery),c("SSB","NPI_nursery")], 
                   ccm_runs_ex2[22,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#22
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$AOI_nursery),c("Recruitment","AOI_nursery")], 
                   ccm_runs_ex2[23,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#23
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$AOI_nursery),c("SSB","AOI_nursery")], 
                   ccm_runs_ex2[24,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#24
  do_null_ccm_runs(block.temp[!is.na(block.temp$Recruitment&block.temp$AMO_nursery),c("Recruitment","AMO_nursery")], 
                   ccm_runs_ex2[25,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#25
  do_null_ccm_runs(block.temp[!is.na(block.temp$SSB&block.temp$AMO_nursery),c("SSB","AMO_nursery")], 
                   ccm_runs_ex2[26,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#26
  ...
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$Fishing_pressure),c("SSB","Fishing_pressure")], 
                   ...
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#2
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$sst_nursery),c("Recruitment","sst_nursery")], 
                   ccm_runs_ex2[3,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#3
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$sst_nursery),c("SSB","sst_nursery")], 
                   ccm_runs_ex2[4,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#4
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$PDO_nursery),c("Recruitment","PDO_nursery")], 
                   ccm_runs_ex2[5,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#5
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$PDO_nursery),c("SSB","PDO_nursery")], 
                   ccm_runs_ex2[6,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#6
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
                   ccm_runs_ex2[7,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#7
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPGO_nursery),c("SSB","NPGO_nursery")], 
                   ccm_runs_ex2[8,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#8
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPA_nursery),c("Recruitment","NPA_nursery")], 
                   ccm_runs_ex2[9,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#9
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPA_nursery),c("SSB","NPA_nursery")], 
                   ccm_runs_ex2[10,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#10
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$WP_nursery),c("Recruitment","WP_nursery")], 
                   ccm_runs_ex2[11,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#11
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$WP_nursery),c("SSB","WP_nursery")], 
                   ccm_runs_ex2[12,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#12
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NAO_nursery),c("Recruitment","NAO_nursery")], 
                   ccm_runs_ex2[13,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#13
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$NAO_nursery),c("SSB","NAO_nursery")], 
                   ccm_runs_ex2[14,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#14
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$SOI_nursery),c("Recruitment","SOI_nursery")], 
                   ccm_runs_ex2[15,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#15
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$SOI_nursery),c("SSB","SOI_nursery")], 
                   ccm_runs_ex2[16,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#16
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
                   ccm_runs_ex2[17,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#17
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$Nino34_nursery),c("SSB","Nino34_nursery")], 
                   ccm_runs_ex2[18,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#18
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NOI_nursery),c("Recruitment","NOI_nursery")], 
                   ccm_runs_ex2[19,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#19
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$NOI_nursery),c("SSB","NOI_nursery")], 
                   ccm_runs_ex2[20,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#20
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPI_nursery),c("Recruitment","NPI_nursery")], 
                   ccm_runs_ex2[21,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#21
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPI_nursery),c("SSB","NPI_nursery")], 
                   ccm_runs_ex2[22,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#22
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AOI_nursery),c("Recruitment","AOI_nursery")], 
                   ccm_runs_ex2[23,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#23
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$AOI_nursery),c("SSB","AOI_nursery")], 
                   ccm_runs_ex2[24,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#24
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AMO_nursery),c("Recruitment","AMO_nursery")], 
                   ccm_runs_ex2[25,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#25
  do_null_ccm_runs(block.temp1[!is.na(block.temp1$SSB&block.temp1$AMO_nursery),c("SSB","AMO_nursery")], 
                   ccm_runs_ex2[26,],
                   n.surr = number_of_surrogates, silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#26
...
save(results_null_CCM_ex2,file='./nurseryenv_ccm_null.Rdata')
#ccm_runs_ex2
...
results_CCM_lags<- do.call(rbind,list(
  ...
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$Fishing_pressure),c("SSB","Fishing_pressure")], 
    ...
    mutate(species = "Yellow_Sea",label="B&C"),#2
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$sst_nursery),c("Recruitment","sst_nursery")], 
                      ccm_runs_ex2[3,], lag_list = seq(-5,0,by=1),silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#3
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$sst_nursery),c("SSB","sst_nursery")], 
                      ccm_runs_ex2[4,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#4
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$PDO_nursery),c("Recruitment","PDO_nursery")], 
                      ccm_runs_ex2[5,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#5
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$PDO_nursery),c("SSB","PDO_nursery")], 
                      ccm_runs_ex2[6,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#6
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
                      ccm_runs_ex2[7,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#7
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$NPGO_nursery),c("SSB","NPGO_nursery")], 
                      ccm_runs_ex2[8,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#8
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$NPA_nursery),c("Recruitment","NPA_nursery")], 
                      ccm_runs_ex2[9,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#9
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$NPA_nursery),c("SSB","NPA_nursery")], 
                      ccm_runs_ex2[10,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#10
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$WP_nursery),c("Recruitment","WP_nursery")], 
                      ccm_runs_ex2[11,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#11
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$WP_nursery),c("SSB","WP_nursery")], 
                      ccm_runs_ex2[12,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#12
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$NAO_nursery),c("Recruitment","NAO_nursery")], 
                      ccm_runs_ex2[13,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#13
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$NAO_nursery),c("SSB","NAO_nursery")], 
                      ccm_runs_ex2[14,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#14
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$SOI_nursery),c("Recruitment","SOI_nursery")], 
                      ccm_runs_ex2[15,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#15
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$SOI_nursery),c("SSB","SOI_nursery")], 
                      ccm_runs_ex2[16,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#16
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
                      ccm_runs_ex2[17,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#17
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$Nino34_nursery),c("SSB","Nino34_nursery")], 
  ...
  #            ccm_runs_ex2, silent = TRUE) %>%
  #mutate(species = "Yellow_Sea",label="B&C"),#20
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$NOI_nursery),c("Recruitment","NOI_nursery")], 
                      ccm_runs_ex2[19,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#21
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$NOI_nursery),c("SSB","NOI_nursery")], 
                      ccm_runs_ex2[20,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#22
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$NPI_nursery),c("Recruitment","NPI_nursery")], 
                      ccm_runs_ex2[21,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#23
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$NPI_nursery),c("SSB","NPI_nursery")], 
                      ccm_runs_ex2[22,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#24
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$AOI_nursery),c("Recruitment","AOI_nursery")], 
                      ccm_runs_ex2[23,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#25
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$AOI_nursery),c("SSB","AOI_nursery")], 
                      ccm_runs_ex2[24,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#26
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$Recruitment&block.temp$AMO_nursery),c("Recruitment","AMO_nursery")], 
                      ccm_runs_ex2[25,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "Yellow_Sea",label="B&C"),#27
  do_ccm_lag_analysis(block.temp[!is.na(block.temp$SSB&block.temp$AMO_nursery),c("SSB","AMO_nursery")], 
  ...
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$Fishing_pressure),c("SSB","Fishing_pressure")], 
                      ccm_runs_ex2[2,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#2
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$sst_nursery),c("Recruitment","sst_nursery")], 
                      ccm_runs_ex2[3,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#3
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$sst_nursery),c("SSB","sst_nursery")], 
                      ccm_runs_ex2[4,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#4
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$PDO_nursery),c("Recruitment","PDO_nursery")], 
                      ccm_runs_ex2[5,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#5
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$PDO_nursery),c("SSB","PDO_nursery")], 
                      ccm_runs_ex2[6,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#6
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
                      ccm_runs_ex2[7,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#7
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPGO_nursery),c("SSB","NPGO_nursery")], 
                      ccm_runs_ex2[8,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#8
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPA_nursery),c("Recruitment","NPA_nursery")], 
                      ccm_runs_ex2[9,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#9
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPA_nursery),c("SSB","NPA_nursery")], 
                      ccm_runs_ex2[10,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#10
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$WP_nursery),c("Recruitment","WP_nursery")], 
                      ccm_runs_ex2[11,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#11
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$WP_nursery),c("SSB","WP_nursery")], 
                      ccm_runs_ex2[12,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#12
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NAO_nursery),c("Recruitment","NAO_nursery")], 
                      ccm_runs_ex2[13,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#13
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$NAO_nursery),c("SSB","NAO_nursery")], 
                      ccm_runs_ex2[14,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#14
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$SOI_nursery),c("Recruitment","SOI_nursery")], 
                      ccm_runs_ex2[15,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#15
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$SOI_nursery),c("SSB","SOI_nursery")], 
                      ccm_runs_ex2[16,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#16
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
                      ccm_runs_ex2[17,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#17
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$Nino34_nursery),c("SSB","Nino34_nursery")], 
                      ccm_runs_ex2[18,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#18
  #do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$PDO_nursery),c("Recruitment","PDO_nursery")], 
  #            ccm_runs_ex2, silent = TRUE) %>%
  ...
  #            ccm_runs_ex2, silent = TRUE) %>%
  #mutate(species = "YBohai_Sea",label="JABBA_B&R"),#20
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NOI_nursery),c("Recruitment","NOI_nursery")], 
                      ccm_runs_ex2[19,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#19
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$NOI_nursery),c("SSB","NOI_nursery")], 
                      ccm_runs_ex2[20,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#20
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPI_nursery),c("Recruitment","NPI_nursery")], 
                      ccm_runs_ex2[21,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#21
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPI_nursery),c("SSB","NPI_nursery")], 
                      ccm_runs_ex2[22,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#22
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AOI_nursery),c("Recruitment","AOI_nursery")], 
                      ccm_runs_ex2[23,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#23
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$AOI_nursery),c("SSB","AOI_nursery")], 
                      ccm_runs_ex2[24,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#24
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AMO_nursery),c("Recruitment","AMO_nursery")], 
                      ccm_runs_ex2[25,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#25
  do_ccm_lag_analysis(block.temp1[!is.na(block.temp1$SSB&block.temp1$AMO_nursery),c("SSB","AMO_nursery")], 
                      ccm_runs_ex2[26,], lag_list = seq(-5,0,by=1), silent = TRUE) %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#26
...
results_CCM_lags2<- do.call(rbind,list(
  ...
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$Fishing_pressure),c("SSB","Fishing_pressure")], 
    ...
    mutate(species = "Yellow_Sea",label="B&C"),#2
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$sst_nursery),c("Recruitment","sst_nursery")], 
                       ccm_runs_ex2[3,], lag_list = seq(-5,0,by=1),silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#3
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$sst_nursery),c("SSB","sst_nursery")], 
                       ccm_runs_ex2[4,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#4
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$PDO_nursery),c("Recruitment","PDO_nursery")], 
                       ccm_runs_ex2[5,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#5
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$PDO_nursery),c("SSB","PDO_nursery")], 
                       ccm_runs_ex2[6,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#6
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
                       ccm_runs_ex2[7,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#7
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$NPGO_nursery),c("SSB","NPGO_nursery")], 
                       ccm_runs_ex2[8,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#8
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$NPA_nursery),c("Recruitment","NPA_nursery")], 
                       ccm_runs_ex2[9,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#9
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$NPA_nursery),c("SSB","NPA_nursery")], 
                       ccm_runs_ex2[10,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#10
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$WP_nursery),c("Recruitment","WP_nursery")], 
                       ccm_runs_ex2[11,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#11
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$WP_nursery),c("SSB","WP_nursery")], 
                       ccm_runs_ex2[12,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#12
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$NAO_nursery),c("Recruitment","NAO_nursery")], 
                       ccm_runs_ex2[13,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#13
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$NAO_nursery),c("SSB","NAO_nursery")], 
                       ccm_runs_ex2[14,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#14
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$SOI_nursery),c("Recruitment","SOI_nursery")], 
                       ccm_runs_ex2[15,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#15
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$SOI_nursery),c("SSB","SOI_nursery")], 
                       ccm_runs_ex2[16,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#16
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
                       ccm_runs_ex2[17,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#17
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$Nino34_nursery),c("SSB","Nino34_nursery")], 
  ...
  #            ccm_runs_ex2, silent = TRUE)[,c(-2,-3)] %>%
  #mutate(species = "Yellow_Sea",label="B&C"),#20
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$NOI_nursery),c("Recruitment","NOI_nursery")], 
                       ccm_runs_ex2[19,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#21
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$NOI_nursery),c("SSB","NOI_nursery")], 
                       ccm_runs_ex2[20,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#22
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$NPI_nursery),c("Recruitment","NPI_nursery")], 
                       ccm_runs_ex2[21,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#23
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$NPI_nursery),c("SSB","NPI_nursery")], 
                       ccm_runs_ex2[22,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)]%>%
    mutate(species = "Yellow_Sea",label="B&C"),#24
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$AOI_nursery),c("Recruitment","AOI_nursery")], 
                       ccm_runs_ex2[23,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#25
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$AOI_nursery),c("SSB","AOI_nursery")], 
                       ccm_runs_ex2[24,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#26
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$Recruitment&block.temp$AMO_nursery),c("Recruitment","AMO_nursery")], 
                       ccm_runs_ex2[25,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "Yellow_Sea",label="B&C"),#27
  do_ccm_lag_analysis2(block.temp[!is.na(block.temp$SSB&block.temp$AMO_nursery),c("SSB","AMO_nursery")], 
  ...
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$Fishing_pressure),c("SSB","Fishing_pressure")], 
                       ccm_runs_ex2[2,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#2
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$sst_nursery),c("Recruitment","sst_nursery")], 
                       ccm_runs_ex2[3,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#3
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$sst_nursery),c("SSB","sst_nursery")], 
                       ccm_runs_ex2[4,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#4
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$PDO_nursery),c("Recruitment","PDO_nursery")], 
                       ccm_runs_ex2[5,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#5
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$PDO_nursery),c("SSB","PDO_nursery")], 
                       ccm_runs_ex2[6,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#6
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPGO_nursery),c("Recruitment","NPGO_nursery")], 
                       ccm_runs_ex2[7,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#7
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPGO_nursery),c("SSB","NPGO_nursery")], 
                       ccm_runs_ex2[8,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#8
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPA_nursery),c("Recruitment","NPA_nursery")], 
                       ccm_runs_ex2[9,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#9
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPA_nursery),c("SSB","NPA_nursery")], 
                       ccm_runs_ex2[10,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#10
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$WP_nursery),c("Recruitment","WP_nursery")], 
                       ccm_runs_ex2[11,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#11
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$WP_nursery),c("SSB","WP_nursery")], 
                       ccm_runs_ex2[12,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#12
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NAO_nursery),c("Recruitment","NAO_nursery")], 
                       ccm_runs_ex2[13,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#13
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$NAO_nursery),c("SSB","NAO_nursery")], 
                       ccm_runs_ex2[14,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#14
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$SOI_nursery),c("Recruitment","SOI_nursery")], 
                       ccm_runs_ex2[15,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#15
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$SOI_nursery),c("SSB","SOI_nursery")], 
                       ccm_runs_ex2[16,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#16
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$Nino34_nursery),c("Recruitment","Nino34_nursery")], 
                       ccm_runs_ex2[17,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#17
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$Nino34_nursery),c("SSB","Nino34_nursery")], 
                       ccm_runs_ex2[18,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#18
  #do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$PDO_nursery),c("Recruitment","PDO_nursery")], 
  #            ccm_runs_ex2, silent = TRUE)[,c(-2,-3)] %>%
  ...
  #            ccm_runs_ex2, silent = TRUE)[,c(-2,-3)] %>%
  #mutate(species = "YBohai_Sea",label="JABBA_B&R"),#20
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NOI_nursery),c("Recruitment","NOI_nursery")], 
                       ccm_runs_ex2[19,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#19
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$NOI_nursery),c("SSB","NOI_nursery")], 
                       ccm_runs_ex2[20,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#20
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$NPI_nursery),c("Recruitment","NPI_nursery")], 
                       ccm_runs_ex2[21,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#21
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$NPI_nursery),c("SSB","NPI_nursery")], 
                       ccm_runs_ex2[22,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#22
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AOI_nursery),c("Recruitment","AOI_nursery")], 
                       ccm_runs_ex2[23,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#23
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$AOI_nursery),c("SSB","AOI_nursery")], 
                       ccm_runs_ex2[24,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#24
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$Recruitment&block.temp1$AMO_nursery),c("Recruitment","AMO_nursery")], 
                       ccm_runs_ex2[25,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#25
  do_ccm_lag_analysis2(block.temp1[!is.na(block.temp1$SSB&block.temp1$AMO_nursery),c("SSB","AMO_nursery")], 
                       ccm_runs_ex2[26,], lag_list = seq(-5,0,by=1), silent = TRUE)[,c(-2,-3)] %>%
    mutate(species = "YBohai_Sea",label="JABBA_B&R"),#26
...
results_multi_ex2 <- do.call(rbind,
                             list(do_multivariate_E_analysis(data=full_join(bio.Yel
                                  ...
                                  do_multivariate_E_analysis(data=full_join(bio.Yel
                                                                            ,phys.Yel,by="Year"),
                                                             pred_col = 'Recruitment',lag_col = 'SSB',other_col='sst_nursery',
                                                             first_column_time = TRUE, E = E.list) %>%
                                    mutate(species = "Yellow_Sea",pred_vars=paste("SSB","sst_nursery",sep = ";")),
                                  do_multivariate_E_analysis(data=full_join(bio.Yel
                                                                            ,phys.Yel,by="Year"),
                                  ...
                                  do_multivariate_E_analysis(data=full_join(bio.Bohai.raw,phys.Bohai,by="Year"),
                                                             pred_col = 'Recruitment',lag_col = 'SSB',other_col='sst_nursery',
                                                             first_column_time = TRUE, E = E.list) %>%
                                    mutate(species = "YBohai_Sea", pred_vars=paste("SSB","sst_nursery",sep = ";")),
                                  do_multivariate_E_analysis(data=full_join(bio.Bohai.raw,phys.Bohai,by="Year"),
                                                             pred_col = 'Recruitment',lag_col = 'SSB',other_col='summer_fishing_moratorium',
                                                             first_column_time = TRUE, E = E.list) %>%
                                  ...
                                  do_multivariate_E_analysis(data=full_join(bio.Bohai.VAST,phys.Bohai,by="Year"),
                                                             pred_col = 'Recruitment',lag_col = 'SSB',other_col='sst_nursery',
                                                             first_column_time = TRUE, E = E.list) %>%
                                    mutate(species = "YBohai_Sea_Seasonal", pred_vars=paste("SSB","sst_nursery",sep = ";"))
                             ))
...
plot_spec <- list(list('Yellow_Sea','SSB;Fishing_pressure')
                  ,list('YBohai_Sea','SSB;sst_nursery'),
                  list('YBohai_Sea_Seasonal','SSB;sst_nursery'))
...
#Yel_Fishing-Bo_sst_nursery-BoV_sst_nursery
...
h_mex2 <- vector(mode='list',3)
plot_spec <- list(list('Yellow_Sea','SSB;sst_nursery')
                  ,list('YBohai_Sea','SSB;sst_nursery'),
                  list('YBohai_Sea_Seasonal','SSB;sst_nursery'))
for(i_plot in 1:length(plot_spec)){
  species_i <- plot_spec[[i_plot]][[1]]
...
#Yel_sst_nursery-Bo_sst_nursery-BoV_sst_nursery
...
h_mex2 <- vector(mode='list',3)
plot_spec <- list(list('Yellow_Sea','SSB;Fishing_pressure')
                  ,list('Yellow_Sea','SSB;sst_nursery'),
...
#Yel_Fishing-Yel_sst_nursery-Yel_moratorium
...
#JABBA-B_R_Fishing-JABBA-B_R_sst_nursery-JABBA-B_R_moratorium
...
#SSB_R_Fishing-SSB_R_sst_nursery-SSB_R_moratorium
